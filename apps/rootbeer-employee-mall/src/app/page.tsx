  ...
  return (
    <div className="relative -mx-4 -mt-4 mb-7 px-6 sm:px-8 pt-9 pb-9 min-h-[248px] flex flex-col justify-end overflow-hidden border-b border-line-soft bg-gradient-to-br from-clay-50 via-paper-card to-ocher-50">
      <div className="flex items-center justify-between mb-auto">
        <span className="font-serif italic text-[15px] text-clay-600">This week&apos;s edit</span>
        {dday && (
  ...
  return (
    <div className="flex items-baseline justify-between mb-4 mt-11">
      <div className="flex items-baseline gap-3">
        <span className="font-serif italic text-[18px] text-clay-500 tnum">{num}</span>
...
function FeatureCard({ product }: { product: Product }) {
  return (
    ...
    >
      <div className="relative bg-line-soft min-h-[200px] overflow-hidden">
        {product.imageUrl && (
          <img
      ...
      <div className="p-5 sm:p-6 flex flex-col justify-center">
        <span className="font-serif italic text-[14px] text-clay-600 mb-2.5">에디터의 선택</span>
        ...
        <span className="mt-4 self-start font-serif italic text-[14px] text-ink-900 border-b border-clay-500 pb-0.5 transition-colors group-hover:border-clay-600">
          담기 →
        </span>
      </div>
    </Link>
...
export default function HomePage() {
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          <p className="font-serif italic text-[15px] tracking-[0.2em] text-clay-500 mb-3">Employee Beauty</p>
  ...
  return (
    <div>
        ...
        <div className="space-y-1.5 mb-4">
          {openRounds.slice(1).map((r) => (
            <div key={r.id} className="bg-clay-50 rounded-lg px-3 py-2 text-xs text-ink-600">
              <span className="font-serif italic text-clay-600">접수중</span>
      ...
      {lastUpdated && <p className="text-[11px] italic text-ink-400 font-serif">Last updated · {lastUpdated}</p>}
