  ...
  (
    ...
    return (
      <Label
        ref={ref}
        className={cn(
          'hover:bg-accent/50 has-[[aria-checked=true]]:border-primary has-[[aria-checked=true]]:bg-primary/10 dark:has-[[aria-checked=true]]:border-primary dark:has-[[aria-checked=true]]:bg-primary/20 flex cursor-pointer items-start gap-3 rounded border p-3',
