      ...
      <div className="flex flex-col flex-wrap gap-2 lg:flex-row">
        {displayItems.map(item => {
          ...
          return (
            <div
              key={item.apartId}
              className="flex justify-between rounded border-l-4 bg-gray-100 py-3 pl-3 pr-1 lg:rounded-full lg:border-none lg:py-2"
              style={{ borderColor: item.color }}
            >
              <div className="flex items-center gap-x-2">
                <span
                  className="hidden h-[10px] w-[10px] rounded-full lg:block"
              ...
              <div className="-mt-1.5 flex items-start lg:ml-2 lg:mt-[2px]">
                <Button
                  size="xs"
                  variant="ghost"
                  rounded
