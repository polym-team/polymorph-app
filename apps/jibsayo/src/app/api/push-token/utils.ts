...
// Firestore Admin 클라이언트 (Lazy initialization)
let _firestoreClient: AdminFirestoreClient | null = null;

function getFirestoreClient(): AdminFirestoreClient {
  if (!_firestoreClient) {
    _firestoreClient = new AdminFirestoreClient({
...
export { getFirestoreClient as firestoreClient };
