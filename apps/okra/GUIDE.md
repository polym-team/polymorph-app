...
| Phase | 내용 | 상태 |
|---|---|---|
| **Phase 1** | GUIDE.md 작성 + 프로세스 확정 | **현재 단계** |
| **Phase 2** | Prisma 스키마 재설계 + 에디터 패키지 설치 | 예정 |
| **Phase 3** | OKR CRUD (생성/목록/상세) | 예정 |
| **Phase 4** | 아이디어 → 목표 → 작업 작성 플로우 | 예정 |
| **Phase 5** | 진행 기록 (에디터 + 공동 편집) | 예정 |
| **Phase 6** | 회고 + 아카이빙 | 예정 |
